...
const mitraHotelAccountSlice = createSlice({
  name: "mitraHotelAccount", // Updated slice name
  initialState,
  reducers: {
    // Get Mitra Hotel Profile
    ...
    // Upload Mitra Hotel Profile Picture
    ...
    // Delete Mitra Hotel Profile Picture
    ...
    // Reset state
    resetMitraHotelAccountState: (state) => { // Renamed reset function
...
export const {
  ...
  resetMitraHotelAccountState, // Export renamed reset function
} = mitraHotelAccountSlice.actions;

export default mitraHotelAccountSlice.reducer;