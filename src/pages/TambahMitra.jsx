...
const TambahMitra = ({ isSidebarOpen }) => {
      ...
      <div className={`bg-ungu10 pt-20 h-screen transition-all duration-300 ${isSidebarOpen ? "ml-16 md:ml-64 w-[calc(100%-64px)] md:w-[calc(100%-256px)]" : "ml-0 w-full"}`}>
        <div className="grid grid-cols-2 px-4">
          <div className="flex flex-col md:flex-row text-left md:gap-1">
            ...
            <p className="text-xs pt-2  text-gray-600">Tambah Mitra</p>
          </div>
          <div className="flex flex-row justify-end">
            ...
            <Link to="/tambah-mitra" className="flex items-center gap-1 text-gray-600 pt-9 md:pt-0 ml-1">
              <p>/</p>
              <p className="text-xs md:text-sm">Tambah Mitra</p>
            </Link>
          </div>
        </div>
                    ...
                    <div className="flex flex-col col-span-2">
                        <div className="items-center justify-center mb-4 gap-2">
                            <div className="flex w-full md:w-1/2 items-center border rounded-lg p-2 bg-gray-100">
                              ...
                              <input type="text" placeholder="Nama Mitra" className="w-full bg-transparent focus:outline-none" />
                            </div>
                        </div>
                        <div className="items-center justify-center mb-4 gap-2">
                            <div className="flex w-full md:w-1/2 items-center border rounded-lg p-2 bg-gray-100">
