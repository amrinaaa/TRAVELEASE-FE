      ...
      <div className="px-6 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            ...
            <div className="text-3xl text-left font-bold text-gray-900 mb-1">
              {roomsData.availableRoomToday}
            </div>
            <div className="flex items-center text-sm">
              <span className={`${roomsData.percentageChange.startsWith('+') ? 'text-green-600' : 'text-red-600'} font-medium`}>
                {roomsData.percentageChange}
              </span>
              <span className="text-gray-500 ml-2">Since last week</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            ...
            <div className="text-3xl text-left font-bold text-gray-900 mb-1">
              {activeBookingsData.activeToday}
            </div>
            <div className="flex items-center text-sm">
              <span className={`${activeBookingsData.percentageChange.startsWith('+') ? 'text-green-600' : 'text-red-600'} font-medium`}>
                {activeBookingsData.percentageChange}
              </span>
              <span className="text-gray-500 ml-2">Since last week</span>
            </div>
          </div>
